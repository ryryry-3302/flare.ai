...
const Editor = () => {
  ...
  return (
    <div className="border rounded-md overflow-hidden bg-white">
      ...
      <div className="flex items-center justify-between bg-slate-100 px-3 py-2 border-b">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1 px-3 py-1 bg-green-600 text-white text-sm font-medium rounded"
          >
      ...
      {/* Metrics Panel */}
      {showMetrics && editor && <MetricsPanel onClose={() => setShowMetrics(false)} editor={editor} />}
    </div>
  );
};
